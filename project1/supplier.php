...
$(function() {
	...
	$('button.edit').click(function() {
		...
		$('#sub_accname').val(tr.children(':eq(4)').text());
		
		$('#sub_accnum').val(tr.children(':eq(5)').text()); //อ่านค่าแอตทริบิวต์ href ของลิงก์ที่อยู่ในเซลล์ที่ 2
...
<tr><th>ลำดับ</th><th>ชื่อผู้จัดส่งสินค้า</th><th>ที่อยู่</th><th>โทร</th><th>ชื่อบัญชี</th><th>เลขบัญชี</th><th>คำสั่ง</th></tr>
<?php
$row = $first;
...
<tr>
    ...
    <td><?php echo $sup['sub_accname']; ?></td>
...
<input type="text" name="sub_accname" id="sub_accname" placeholder="ชื่อบัญชี"><br>
<input type="text" name="sub_accnum" id="sub_accnum" placeholder="เลขบัญชี"><br><br>
