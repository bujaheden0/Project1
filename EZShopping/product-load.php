...
<?php
	...
	$sql = "SELECT * FROM product_images WHERE pro_id = $pro_id ORDER BY img_id ASC";
...
?>     
    ...
    <button type="button" id="dialog-add-cart" data-id="<?php echo $id; ?>" <?php if($out_of_stock) { echo "disabled"; }?>>ใส่ตะกร้า</button>
    </form>
</div>
